...
- **Skills placement** — skills now install to `.claude/skills/<name>/SKILL.md` (the correct Claude Code convention) instead of `skills/<name>.md`
- Skills are now discoverable as `/odoo-brainstorm`, `/odoo-architect`, `/odoo-debug` slash commands in Claude Code

### Changed

- Bundled skill data restructured from flat files to `data/skills/<name>/SKILL.md` directories
- Updated all documentation to reference `.claude/skills/` paths
